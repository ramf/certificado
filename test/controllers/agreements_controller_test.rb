...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { client_name: @agreement.client_name, description: @agreement.description, price: @agreement.price } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { client_name: @agreement.client_name, description: @agreement.description, price: @agreement.price } }
