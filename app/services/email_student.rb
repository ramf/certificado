  ...
  def self.send_student(student)
    ...
    mail = Mail.new do
     ...
     html_part do
      ...
      url = "http://localhost:3000/students/#{student.id}/export"
      body "<p> Olá #{student.name}, seu certificado está pronto! Clique no PDF em anexo para baixar.</p>"
     end
  end
    puts mail.to_s
